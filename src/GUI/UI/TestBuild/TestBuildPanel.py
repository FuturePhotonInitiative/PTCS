...
class TestBuildPanel(DisplayPanel):
    def __init__(self, parent):
        ...
        self.list_box.SetBackgroundColour(GUI_CONSTANTS.TEST_BUILD_PANEL_COLOR)
        self.list_box.SetForegroundColour(GUI_CONSTANTS.TEST_BUILD_PANEL_FOREGROUND_COLOR)
