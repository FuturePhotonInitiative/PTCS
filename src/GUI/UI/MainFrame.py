import wx
from src.Gui.UI.ResultsPage import ResultsPage
from src.Gui.UI.HardwarePage import HardwarePage
from src.Gui.UI.BuildExperimentPage import BuildExperimentsPage
from src.Gui.UI.QueuePage import QueuePage
